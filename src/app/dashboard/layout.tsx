...
export default async function DashboardLayout({
  ...
  return (
    // LockProvider + LockScreen di sini (bukan di root Providers) — lock cuma
    // relevan area authed; di root, supabase-js ikut ke bundle landing/marketing.
    <LockProvider>
      <div
      ...
      {/* Overlay PIN lock (fixed z-100) — harus di dalam LockProvider */}
      <LockScreen />
    </LockProvider>
  )
}
