...
/**
 * Sanitasi param `next` → hanya izinkan PATH internal absolut.
 * Tolak protocol-relative ("//evil.com"), backslash trick ("/\\evil.com"),
 * dan apa pun yang bukan diawali "/" — anti open-redirect (security-3).
 */
