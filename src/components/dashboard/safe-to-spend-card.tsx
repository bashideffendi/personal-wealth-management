 ...
 * yang belum jatuh tempo = berapa yang masih bebas dipakai. Paling actionable
 * buat keputusan harian. Ngisi penuh tingginya (hero number + bar + breakdown).
 */
  ...
  return (
    <article className="s-card flex flex-col h-full" style={{ padding: 24 }}>
      ...
      <div className="flex-1 flex flex-col justify-center py-2">
        <p className="num tabular leading-none font-bold" style={{ fontSize: 44, letterSpacing: '-0.02em', color: numColor }}>
          {formatCurrency(safe)}
        </p>
        <p className="text-[12.5px] mt-2 font-medium" style={{ color: numColor }}>
