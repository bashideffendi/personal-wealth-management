 ...
 *
 * Node: perusahaan = teal (#17b890) label=symbol · investor = abu (#71717A)
...
const C = {
  mint: '#17b890', // --c-mint teal (perusahaan)
  primary: '#18181b', // --c-primary (emiten aktif / ink)
  investor: '#71717A', // abu (investor) — antara --ink-muted & --ink-soft
  edge: '#E4E4E7', // hairline edge (turunan --border)
  edgeHi: '#17b890', // edge ke-highlight pas hover
  label: '#18181b', // --ink
  white: '#FFFFFF',
} as const
